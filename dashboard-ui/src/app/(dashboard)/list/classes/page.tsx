...
const ClassListPage = async ({
  ...
  const renderRow = (item: ClassList) => (
    ...
    >
      ...
      <td className="hidden md:table-cell">{item.grade?.level || (item.gradeId ? `Grade ${item.gradeId}` : 'N/A')}</td>
  ...
  if (sortBy) {
    switch (sortBy) {
      ...
      case "capacity":
        ...
        break;
      case "supervisor":
        orderBy = { supervisor: { name: sortOrder } };
        break;
      default:
        orderBy = { name: "asc" };
    }
  ...
  const sortOptions = [
    ...
    { key: "supervisor", label: "Giáo viên phụ trách" },
  ];
